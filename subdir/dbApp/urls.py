...
urlpatterns = (
    url(r'^$', views.Search),
    url(r'^musicians/search/$', views.UserMusicianSearch),
    url(r'^songs/search/$', views.UserSongSearch),
    url(r'^albums/search/$', views.UserAlbumSearch),
    url(r'^admin_panel/musicians/search/$', views.MusicianSearch),
    url(r'^admin_panel/songs/search/$', views.SongSearch),
    url(r'^admin_panel/albums/search/$', views.AlbumSearch),
    url(r'^admin_panel/instruments/search/$', views.InstrumentSearch),
    url(r'^admin_panel/performs/search/$', views.PerformsSearch),
    url(r'^admin_panel/appears_on/search/$', views.AppearsOnSearch),
    url(r'^admin_panel/plays/search/$', views.PlaysSearch),
    url(r'^admin_panel/addresses/search/$', views.AddressSearch),
    ...
    url(r'^admin_panel/users/$', views.UserLookup),
    url(r'^admin_panel/users/search/$', views.UserSearch),
    url(r'^admin_panel/users/insert/$', views.UserInsert),
    url(r'^admin_panel/users/(?P<user>[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};\\|,.<>\/? ]+)/edit/$', views.UserUpdate),
    url(r'^admin_panel/users/(?P<user>[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};\\|,.<>\/? ]+)/delete/$', views.UserDelete),
